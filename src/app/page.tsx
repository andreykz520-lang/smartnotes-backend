      ...
      <section className="relative pt-36 pb-20 lg:pt-48 lg:pb-32 overflow-hidden flex flex-col items-center text-center">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 w-full sm:w-auto flex-wrap">
            ...
            <a
              href="/SmartNotes-Linux.AppImage"
              className="w-full sm:w-auto flex items-center justify-center gap-2 px-7 py-3.5 rounded-full bg-white/10 hover:bg-white/20 text-white font-bold text-sm sm:text-base border border-white/20 transition-all backdrop-blur-md"
            >
              🐧 {t('download_linux_appimage')}
            </a>
            <a
              href="/SmartNotes-Linux.deb"
              className="w-full sm:w-auto flex items-center justify-center gap-2 px-7 py-3.5 rounded-full bg-white/10 hover:bg-white/20 text-white font-bold text-sm sm:text-base border border-white/20 transition-all backdrop-blur-md"
            >
              🐧 {t('download_linux_deb')}
            </a>
            <a
              href="/SmartNotes-Linux.tar.gz"
              className="w-full sm:w-auto flex items-center justify-center gap-2 px-7 py-3.5 rounded-full bg-white/10 hover:bg-white/20 text-white font-bold text-sm sm:text-base border border-white/20 transition-all backdrop-blur-md"
            >
              🐧 {t('download_linux_tar')}
            </a>
            <a
              href="/SmartNotes.apk"
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto mb-16">
            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl p-6 sm:p-8 flex flex-col items-center text-center">
              ...
              <div className="flex flex-col gap-2 w-full">
                ...
                <a href="/SmartNotes-Linux.AppImage" className="w-full py-2.5 rounded-xl bg-white/5 border border-white/10 text-center text-xs font-semibold hover:bg-white/10 transition-colors">
                  🐧 {t('download_linux_appimage')}
                </a>
                ...
                <a href="/SmartNotes-Linux.tar.gz" className="w-full py-2.5 rounded-xl bg-white/5 border border-white/10 text-center text-xs font-semibold hover:bg-white/10 transition-colors">
                  🐧 {t('download_linux_tar')}
                </a>
              </div>
            </div>
